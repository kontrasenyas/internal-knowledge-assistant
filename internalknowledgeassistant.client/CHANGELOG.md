...
- Create Angular project with ng: `ng new internalknowledgeassistant.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`internalknowledgeassistant.client.esproj`).
