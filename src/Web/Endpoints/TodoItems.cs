using InternalKnowledgeAssistant.Application.Common.Models;
using InternalKnowledgeAssistant.Application.TodoItems.Commands.CreateTodoItem;
using InternalKnowledgeAssistant.Application.TodoItems.Commands.DeleteTodoItem;
using InternalKnowledgeAssistant.Application.TodoItems.Commands.UpdateTodoItem;
using InternalKnowledgeAssistant.Application.TodoItems.Commands.UpdateTodoItemDetail;
using InternalKnowledgeAssistant.Application.TodoItems.Queries.GetTodoItemsWithPagination;
using Microsoft.AspNetCore.Http.HttpResults;

namespace InternalKnowledgeAssistant.Web.Endpoints;
